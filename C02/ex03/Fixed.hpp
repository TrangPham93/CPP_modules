...
public:
	...
	- user-defined copy constructor == explicit copy constructor: to create a deep copy 
		...
		. we need to define our own copy constructor only if an object has pointers or any runtime allocation of the resource like a file handle, a network connection, etc because the default constructor does only shallow copy.*/
